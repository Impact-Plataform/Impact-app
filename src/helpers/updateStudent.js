...
class update {
  static async updateStudent (studentId, name, surname, birthDate, cityOfBirth, adress, educationLevel, maritalStatus,
    ...
    await db.query('UPDATE students SET name = $1, surname = $2, birthdate = $3, city_of_birth = $4, adress = $5, education_level = $6, marital_status = $7, employment_status = $8, income = $9, number_of_household = $10, family_income) = $11 WHERE studentId = $12',
      [name, surname, birthDate, cityOfBirth, adress, educationLevel, maritalStatus, employmentStatus, income, numberOfHousehold, familyIncome, studentId])
